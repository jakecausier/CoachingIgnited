...
if( !class_exists( 'CMB2_Field_Order' ) ) {
    ...
    class CMB2_Field_Order {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-field-order', get_template_directory_uri() . '/includes/cmb2/plugins/js/order.js', array( 'jquery', 'jquery-ui-draggable' ), false, true);
            wp_enqueue_script( 'cmb-field-order' );

            wp_enqueue_style( 'cmb-field-order', get_template_directory_uri() . '/includes/cmb2/plugins/css/order.css', false, false, false);
